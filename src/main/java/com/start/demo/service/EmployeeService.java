...
public class EmployeeService {
    ...
    public Flux<Employee> searchEmployees(String name) { // Note: Returns Employee, not EmployeeResponse for simplicity
                                                         // here
    ...
    public Flux<Employee> getEmployeesBySalaryRange(BigDecimal minSalary, BigDecimal maxSalary) { // Note: Returns
                                                                                                  // Employee
